...
#     "plotly==6.9.0; sys_platform != 'emscripten'",
#     "plotly; sys_platform == 'emscripten'",
#     "pyarrow==25.0.0; sys_platform != 'emscripten'",
#     "pyarrow; sys_platform == 'emscripten'",
#     "pycountry==26.2.16; sys_platform != 'emscripten'",
#     "pycountry; sys_platform == 'emscripten'",
# ]
# ///
...
def _(hierarchy_number, mo, pd):
    ...
    missing_aggregates = (
        ...
        if hasattr(AGGREGATE_DIR, "exists")
        else []
    )
...
def _(AGGREGATE_DIR, country_iso3, math, read_public_parquet, us_state_code):
    ...
    us_state_summary = read_public_parquet(AGGREGATE_DIR / "us_state_counts.parquet")
...
def _(
    ...
    _counts = read_public_parquet(AGGREGATE_DIR / "seniority_counts.parquet")
...
def _(
    ...
    time_series = read_public_parquet(AGGREGATE_DIR / "time_counts.parquet")
